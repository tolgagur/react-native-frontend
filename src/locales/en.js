export default {
  ...
  studySet: {
    ...
    actions: {
      ...
      quickReviewDesc: 'Quickly review cards you\'ve learned',
      test: 'Test',
      testDesc: 'Test yourself and track progress',
      edit: 'Edit',
      share: 'Share',
      delete: 'Delete'
    },
    ...
    empty: 'No cards yet',
    emptySubtext: 'Start learning by adding cards to this study set',
    alerts: {
      shareInfo: 'Coming Soon',
      shareDesc: 'This feature will be available soon'
    },
    steps: {
      name: {
